...
<div id="sidebar" v-el:sidebar>
    ...
    <ul class="nav nav-pills nav-stacked">
        <li role="presentation" :class="{ active: active == 'dashbord'}"><a href="#!/dashbord">{{'dashboard' | i18n}}</a></li>
        <li role="presentation" :class="{ active: active == 'settings'}"><a href="#!/settings">{{'settings' | i18n}}</a></li>
        <li role="presentation" :class="{ active: active == 'categories'}"><a href="#!/categories">
            {{'categories' | i18n}}
            <span class="badge">{{categories}}</span>
        </a></li>
        <li role="presentations" :class="{ active: active == 'albums'}"><a href="#!/albums">
            {{'album' | i18n}}
